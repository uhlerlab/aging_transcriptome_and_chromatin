...
def main():
    ...
    if subset == 'MEFISTO':
        ...
        hic_subset = hic[hic['chr1'].isin(selected_loci['locus']) & 
                           hic['chr2'].isin(selected_loci['locus'])]
    else:
        # create random subset of size 200
        selected_loci = hic['chr1'].sample(200, random_state=1)
        hic_subset = hic[hic['chr1'].isin(selected_loci) & 
                           hic['chr2'].isin(selected_loci)]
