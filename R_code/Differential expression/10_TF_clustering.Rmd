...
TF_features %<>% arrange(DE_enrichment, desc(spec_intermingling))
...
```{r old_net_selected_cols_t, fig.height=6, fig.width = 12}
pheatmap(t(TF_features[TF_order, c('var_expr', 'all_targets', 'DE_enrichment', 'spec_intermingling')]), 
         cluster_cols = FALSE, cluster_rows = FALSE, 
         annotation_col = anno, annotation_legend = FALSE, 
         labels_row = c('Variance of the mean \n expression per age group',
                        'Number of targets \n in the genome', 
                        'Enrichment p-value of \n DE target genes in S3',
                        '% of specific intermingling \n between the DE target \n genes in S3'), 
         fontsize = 11, fontsize_row = 16, fontsize_col = 10)
```
